...
<body>
  <div class="wrapper">
    ...
    <div class="section-light" style="text-align: center;">
      ...
      <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Imagem_inst_1_pkorcn.png" alt="Instrução 1" class="instruction-img" />
      ...
      <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Imagem_inst_2_f5lmeg.png" alt="Instrução 2" class="instruction-img" />
