...
<body>
  <div class="wrapper">
    ...
    <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/Banner_JPR26_dnrutl.png" alt="JPR 2026" class="header-img" />
    ...
    <a href="http://www.radix.med.br" target="_blank" style="display:block;">
      <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/Banner_RX570_vq9ajs.png" alt="Monitor RX570" class="header-img" />
    </a>
    <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/banner_Medecom3_jzu8xc.png" alt="Banner Medecom" class="header-img" />
    ...
    <div class="section-light" style="text-align: center;">
      ...
      <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/Imagem_inst1_pkorcn.png" alt="Instrução 1" class="instruction-img" />
      ...
      <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/Imagem_inst2_f5lmeg.png" alt="Instrução 2" class="instruction-img" />
    ...
    <div class="footer">
      ...
      <div style="text-align: center; margin-top: 40px; margin-bottom: 20px;">
        <img src="https://res.cloudinary.com/dq64vhxeg/image/upload/f_auto,q_auto/Eizo/banner_logo_RADIX_EIZO_i9ufcu.png" alt="Logo RADIX Eizo" style="max-width: 500px; width: 100%; height: auto; display: inline-block;" />
      </div>
